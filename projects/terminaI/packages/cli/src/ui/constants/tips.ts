...
export const INFORMATIVE_TIPS = [
  ...
  'Create a project-specific terminaI.md file with /init...',
  ...
  'Reload instructional context from terminaI.md files with /memory refresh...',
  'List the paths of the terminaI.md files in use with /memory list...',
