...
describe('initCommand', () => {
  ...
  const geminiMdPath = path.join(targetDir, 'terminaI.md');
  ...
  it('should inform the user if terminaI.md already exists', async () => {
  ...
  it('should create terminaI.md and submit a prompt if it does not exist', async () => {
    ...
    expect(mockContext.ui.addItem).toHaveBeenCalledWith(
      {
        type: 'info',
        text: 'Empty terminaI.md created. Now analyzing the project to populate it.',
      },
      expect.any(Number),
    );
