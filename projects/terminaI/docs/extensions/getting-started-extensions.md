...
create a custom command, and provide context to the model with a `terminaI.md`
file.
...
## Step 5: Add a custom `terminaI.md`

You can provide persistent context to the model by adding a `terminaI.md` file
to your extension. This is useful for giving the model instructions on how to
...
1.  Create a file named `terminaI.md` in the root of your extension directory:
...
`terminaI.md` file in every session where the extension is active.
